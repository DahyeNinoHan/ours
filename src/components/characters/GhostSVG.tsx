...
const GhostSVG = ({ colors, className }: GhostSVGProps) => (
  ...
  <g transform="translate(100,100) scale(1.0) translate(-100,-100)">
      ...
      />
      {/* Digital eyes */}
      <rect x="85" y="75" width="8" height="8" fill={colors.baseColor} filter="url(#neonGlow)"/>
      <rect x="107" y="75" width="8" height="8" fill={colors.accentColor} filter="url(#neonGlow)"/>
      <rect x="87" y="77" width="4" height="4" fill="#ffffff"/>
      <rect x="109" y="77" width="4" height="4" fill="#ffffff"/>
      {/* Digital mouth with teeth */}
      <rect x="92" y="95" width="16" height="4" fill={colors.secondaryColor} filter="url(#neonGlow)"/>
