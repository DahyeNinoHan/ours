              ...
              <div className="pt-4">
                <Button
                  ...
                  onClick={() => {
                    ...
                    const species = Object.keys(ENTITY_SPECIES) as Array<keyof typeof ENTITY_SPECIES>;
                    const genders = Object.keys(GENDER_EXPRESSIONS) as Array<keyof typeof GENDER_EXPRESSIONS>;
